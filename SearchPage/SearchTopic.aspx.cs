...
public partial class SearchPage_SearchTopic : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int num = 0;
        string keyWord = "#" + (string)Session["searchWord"] + "#";
        DataSet newsSet = newsDb.SearchByContent(keyWord, "news");
