<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyStars.aspx.cs" Inherits="user_MyStars" %>
    ...
    <div class="wrapper">
        <div class="left_column">
            ...
            <div class="left_item">
                ...
                <a class="p2" href ="MyStars.aspx" style="color: red">我的关注</a><br /><br/>
                 <a class="p2" href= "Mysave.aspx">我的收藏</a><br /><br/>
            </div>
            <hr class="line" />
            <div class="left_item">
                <br />
                <a class="p2">分组</a><br /><br/>
            </div>
            <hr class="line" />
        </div>
