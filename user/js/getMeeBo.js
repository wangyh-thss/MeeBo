function getMeeBo(json) {
    ...
    for (var i = 0; i < a.length; i++) {
        ...
        if (a[i].type == "Meebo") {
            ...
            html = html + '<div class="CTA">' + '<a onclick="javascript:__doPostBack(\'zan_btn\',\'' + a[i].MeeboID + '\')">赞</a>(' + a[i].praise + ')|<a onclick="javascript:__doPostBack(\'repost_btn\',\'' + a[i].MeeboID + '\')">转发</a>(' + a[i].repost + ')|<a onclick="javascript:__doPostBack(\'comment_btn\',\'' + a[i].MeeboID + '\')">评论</a>(' + a[i].comment + ')' + ')|<a onclick="javascript:__doPostBack(\'save_btn\',\'' + a[i].MeeboID + '\')">' + save + '</a>(' + a[i].save + ')' + ' </div>';
            ...
            html = html + '</div>';
            html = html + '<div class="MeeBo_detail"><div class="MeeBo_time">' + a[i].originTime + '</div></div></div><div class="MeeBo_detail"><div class="MeeBo_time">' + a[i].time + '</div><div class="CTA">' + '<a onclick="javascript:__doPostBack(\'zan_btn\',\'' + a[i].MeeboID + '\')">赞</a>(' + a[i].praise + ')|<a onclick="javascript:__doPostBack(\'repost_btn\',\'' + a[i].MeeboID + '\')">转发</a>(' + a[i].repost + ')|<a onclick="javascript:__doPostBack(\'comment_btn\',\'' + a[i].MeeboID + '\')">评论</a>(' + a[i].comment + ')' + ')|<a onclick="javascript:__doPostBack(\'save_btn\',\'' + a[i].MeeboID + '\')">' + save + '</a>(' + a[i].save + ')' + ' </div></div></div></div>';
        }
    }
